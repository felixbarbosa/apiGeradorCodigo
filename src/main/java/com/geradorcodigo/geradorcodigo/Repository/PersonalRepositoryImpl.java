...
public class PersonalRepositoryImpl implements PersonalRepository{
    ...
    private static String UPDATE = " update mc_personal set foto = ?, senha = ? where id = ?";  
    ...
    public Personal atualizarPersonal(Personal personal) {
        ...
        jbdcTemplate.update(UPDATE, new Object[] { personal.getFoto(), personal.getSenha(), personal.getId()});
