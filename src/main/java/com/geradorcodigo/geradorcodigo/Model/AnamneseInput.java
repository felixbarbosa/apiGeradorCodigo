...
public class AnamneseInput {
    ...
    private String alteracaoCardiaca;
...
public String getAlteracaoCardiaca() {
        return alteracaoCardiaca;
}
public void setAlteracaoCardiaca(String alteracaoCardiaca) {
        this.alteracaoCardiaca = alteracaoCardiaca;
}
